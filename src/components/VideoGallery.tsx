...
const videoItems = [
  ...
  {
    id: 4,
    title: "Exploring Akalapuzha Narrow Canals",
    description: "A peaceful cruise navigating through the small palm-fringed channels of rural Akalapuzha.",
  ...
  {
    id: 5,
    title: "Scenic Sunset Akalapuzha Lake",
    description: "Capturing the stunning orange and golden reflections on the Akalapuzha Lake at sunset.",
