      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-12 pt-40 pb-28 flex flex-col justify-center h-full">
        <div className="w-full lg:w-[55%] text-left flex flex-col items-start">
          ...
          >
            ...
            <span className="text-[#C9A227] normal-case">Akalapuzha Boat Service</span>
          </motion.h1>
          ...
          >
            Enjoy a memorable Akalapuzha backwater experience with quality dining, comfortable cruising, and a safe, well-maintained boat ride.
          </motion.p>
