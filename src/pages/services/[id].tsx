...
export default function ServiceDetailPage({ service }: ServiceProps) {
  ...
  return (
    <>
      <Head>
        <title>{`${service.title} | Phoenix Cruise Akalapuzha`}</title>
        <meta name="description" content={`${service.shortDesc} Book your private Akalapuzha boat ride with Phoenix Cruise in Kerala.`} />
        <meta name="keywords" content={`Akalapuzha boat service, ${service.title}, Akalapuzha boat ride, Phoenix Cruise, Akalapuzha, Kerala backwater boat service, Kerala boat cruise`} />
        ...
        <meta property="og:title" content={`${service.title} | Phoenix Cruise Akalapuzha`} />
        ...
        <meta name="twitter:title" content={`${service.title} | Phoenix Cruise Akalapuzha`} />
      ...
      <main className="bg-slate-50 font-sans py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            {/* Benefits Section */}
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-100 space-y-4">
              <h3 className="font-serif font-bold text-lg md:text-xl text-emerald-800 flex items-center">
                <FaCheckCircle className="mr-2.5 text-emerald-500" /> Key Benefits &amp; Features
              </h3>
              <ul className="space-y-3.5 text-xs md:text-sm text-dark/70 font-light">
